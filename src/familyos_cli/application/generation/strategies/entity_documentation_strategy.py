"""Entity documentation generation strategy."""
...
class EntityDocumentationStrategy:
    """Generate entity documentation artifacts."""
    ...
    def execute(
        ...
        """Execute entity documentation generation."""
