"""Full domain documentation generation strategy."""
...
class FullDomainDocumentationStrategy:
    """Generate complete domain documentation artifacts."""
    ...
    def execute(
        ...
        """Execute full domain documentation generation."""
