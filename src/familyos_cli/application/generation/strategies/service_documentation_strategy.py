"""Service documentation generation strategy."""
...
class ServiceDocumentationStrategy:
    """Generate service documentation artifacts."""
    ...
    def execute(
        ...
        """Execute service documentation generation."""
