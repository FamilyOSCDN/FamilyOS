"""Domain context documentation generation strategy."""
...
class DomainContextDocumentationStrategy:
    """Generate domain context documentation artifacts."""
    ...
    def execute(
        ...
        """Execute domain context documentation generation."""
